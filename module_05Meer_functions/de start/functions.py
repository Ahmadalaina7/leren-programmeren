...
def getJourneyFoodCostsInGold(people:int, horses:int) -> float:
    FOODCOSTE_HUMAN_COPPER =  (people*COST_FOOD_HUMAN_COPPER_PER_DAY)*JOURNEY_IN_DAYS
    FOODCOSTE_HORSE_COPPER= (horses*COST_FOOD_HORSE_COPPER_PER_DAY)*JOURNEY_IN_DAYS
